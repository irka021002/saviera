...
export default function ProductGallery({omniaPic,weiyiPic,cyannePic}:ProductGalleryProps){
            ...
            <div className="py-20">
                <div className={`justify-center ${animate} transition-all duration-1000 ease-in-out md:px-0 px-6 grid grid-cols-6 gap-[24px] md:grid-cols-[repeat(12,minmax(0,78px))] md:gap-[24px]`}>
                    <div className="col-span-6 md:col-span-4 flex flex-col">
                        <img className="w-full h-auto" src={cyannePic} alt="Produk 3" />
                    ...
                    <div className="col-span-6 md:col-span-4 flex flex-col">
                        <img className="w-full h-auto" src={weiyiPic} alt="Produk 2" />
                    ...
                    <div className="col-span-6 md:col-span-4 flex flex-col">
                        <img className="w-full h-auto" src={omniaPic} alt="Produk 1" />
