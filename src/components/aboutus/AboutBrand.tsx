...
export default function AboutBrand({aboutHero}:AboutBrandProps){
    ...
    return(
        <div className="relative w-full md:aspect-[12/5] mt-[-80px] md:mt-[-100px] aspect-[36/41]">
            <img className="absolute w-full md:aspect-[12/5] hidden md:inline object-contain" src={aboutHero[0] || "/image/homepage/promocta.png"} alt="Promo CTA Illustration" />
            <img className="absolute w-full aspect-[36/41] inline md:hidden object-contain" src={aboutHero[1] || "/image/homepage/promocta.png"} alt="Promo CTA Illustration" />
