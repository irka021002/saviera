...
export default function OurSentiment(){
    return(
        <div>
            <div className="pt-20 bg-primary-2 justify-center grid grid-cols-[repeat(6,minmax(0,32px))] gap-[16px] md:grid-cols-[repeat(12,minmax(0,78px))] md:gap-[24px] md:gap-y-10">
                <div className="flex col-span-12">
                    <p className="py-4 px-[10px] bg-secondary-2 text-primary-2 font-aboreto text-4xl leading-[135%] text-center">
                        OUR<br />SENTIMENT
                    </p>
                    <p className="grow py-[29px] px-6 text-2xl bg-accent-1 h-full text-center leading-[150%] text-primary-2">
            ...
            <div className="text-center py-20 text-2xl leading-[150%] bg-primary-2">
