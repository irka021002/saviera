            ...
            <div className="justify-center grid grid-cols-6 px-6 md:px-0 break-all gap-[16px] md:grid-cols-[repeat(12,minmax(0,78px))] md:gap-[24px] bg-primary-2">
                <div className="col-span-6 md:col-span-12 py-[80px]">
                    <div className="flex flex-col items-center w-full">
                        ...
                        <button className="border-accent-2 hover:border-opacity-30 mt-10 md:mt-[90px] border text-accent-2 rounded font-montserrat text-xl md:text-[32px] font-medium py-[10px] text-center md:px-[190px] w-full md:w-fit">
                            CLICK HERE!
                        </button>
                    </div>
                    <div className="mt-20">
                    ...
                    <div className="mb-20">
                        ...
                        <div className="flex p-5 text-2xl font-montserrat justify-between items-center flex-col md:flex-row">
                            <button className="text-accent-1 hover:border-opacity-30 rounded border border-secondary-2 py-[10px] w-full md:w-fit md:px-[125px]">
                                Omnia
                            </button>
                            <span className="md:w-[1px] md:h-[38px] h-[1px] my-3 w-[38px] border border-secondary-1"></span>
                            <button className="text-accent-2 hover:border-opacity-30 rounded border border-secondary-2 py-[10px] w-full md:w-fit md:px-[125px]">
                                Cyanne
                            </button>
                            <span className="md:w-[1px] md:h-[38px] h-[1px] my-3 w-[38px] border border-secondary-1"></span>
                            <button className="text-accent-3 hover:border-opacity-30 rounded border border-secondary-2 py-[10px] w-full md:w-fit md:px-[125px]">
                                Wei Yi
                            </button>
                        </div>
                    </div>
