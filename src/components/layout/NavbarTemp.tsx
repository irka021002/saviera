        ...
        <nav className="z-[9999] sticky top-0 max-w-[1440px] m-auto">
            <div className={`justify-center grid grid-cols-6 gap-[16px] px-6 md:px-0 md:grid-cols-[repeat(12,minmax(0,78px))] md:gap-[24px] items-center h-[80px] md:h-[100px] ${changeColor && !checkPath("/01-archetypes") && !checkPath("/01-") && !checkPath("/savdashboard") ? "bg-transparent" : "md:bg-primary-1 bg-[#c8c8c8]"}`}>
                ...
                <div className={`col-span-4 hidden md:flex transition-all duration-500 ease-in-out ${animateMenu}`}>
                    <a href="https://wa.me/628175199968"><img width={32} className="mr-8" src={changeColor && !checkPath("/01-archetypes") && !checkPath("/sav-to-wear-01") && !checkPath("/01-") && !checkPath("/savdashboard") ? WhatsappWhite : Whatsapp} alt="Whatsapp Logo" /></a>
                    <a href="https://www.instagram.com/saviera.co/"><img width={32} className="mr-8" src={changeColor && !checkPath("/01-archetypes") && !checkPath("/sav-to-wear-01") && !checkPath("/01-") && !checkPath("/savdashboard") ? InstagramWhite : Instagram} alt="Instagram Logo" /></a>
