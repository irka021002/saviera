...
export default function Footer(){   
    return(
        <footer>
            <div className="w-full justify-center grid grid-cols-6 px-6 md:px-0 gap-[16px] md:grid-cols-[repeat(12,minmax(0,78px))] md:gap-[24px] py-[80px] bg-primary-2">
                <div className="col-span-6 md:col-span-12 flex flex-col items-center md:justify-between md:items-center md:flex-row">
                    ...
                    <div className="w-full md:w-[30%] md:h-full flex flex-col justify-start">
                        ...
                        <div className="flex justify-between md:hidden">
                            <a className="w-fit py-[13px] border p-3 border-solid border-accent-2 rounded flex justify-center content-center text-accent-2" href="/">
