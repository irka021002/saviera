    ...
    return(
        <footer>
            <div id="footer" className="w-full m-auto justify-center grid grid-cols-6 px-6 md:px-0 gap-[16px] md:grid-cols-[repeat(12,minmax(0,78px))] md:gap-[24px] py-[80px] max-w-[1440px] bg-primary-2">
                <div className={`${animate} transition-all duration-1000 ease-in-out col-span-6 md:col-span-12 flex flex-col items-center md:justify-between md:items-center md:flex-row`}>
                    ...
                    <div className="w-full md:w-[30%] md:h-full">
                        ...
                        <a className="w-full hover:border-opacity-30 py-[13px] border mb-[35px] border-solid border-accent-2 rounded justify-center content-center text-accent-2 hidden md:flex" href="https://ig.me/m/saviera.co" target="_blank"><img height={20} className="mr-3" src={Whatsapp} alt="Whatsapp Logo" />Let us talk about it.</a>
                    ...
                    <div className="w-full md:w-[30%] md:h-full flex flex-col justify-start">
                        ...
                        <div className="flex justify-between md:hidden">
                            <a className="w-fit py-[13px] hover:border-opacity-30 border p-3 border-solid border-accent-2 rounded flex justify-center content-center text-accent-2" href="https://www.facebook.com/saviera.co" target="_blank">
                            ...
                            <a className="w-fit py-[13px] hover:border-opacity-30 border p-3 border-solid border-accent-2 rounded flex justify-center content-center text-accent-2" href="https://pin.it/2p8Gsks" target="_blank">
                            ...
                            <a className="w-fit py-[13px] hover:border-opacity-30 border p-3 border-solid border-accent-2 rounded flex justify-center content-center text-accent-2" href="https://www.instagram.com/saviera.co/" target="_blank">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a className="w-fit py-[13px] hover:border-opacity-30 border p-3 border-solid border-accent-2 rounded flex justify-center content-center text-accent-2" href="mailto:fairy@saviera.co" target="_blank">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ContactButton src={Pinterest} alt="Pinterest Logo" text="Pinterest" href="https://pin.it/2p8Gsks" />
            ...
            <div className="fixed right-6 bottom-6 md:right-10 md:bottom-5">
                <a href="https://wa.me/628175199968?text=Hi%20Saviera.co%0AI%20would%20like%20to%20ask%20about%20....." target="_blank">
