            ...
            <div className="w-full m-auto justify-center grid grid-cols-6 px-6 md:px-0 gap-[16px] md:grid-cols-[repeat(12,minmax(0,78px))] md:gap-[24px] py-[80px] max-w-[1440px] bg-primary-2">
                <div className="col-span-6 md:col-span-12 flex flex-col items-center md:justify-between md:items-center md:flex-row">
                    ...
                    <div className="w-full md:w-[30%] md:h-full">
                        ...
                        <a className="w-full hover:border-opacity-30 py-[13px] border mb-[35px] border-solid border-accent-2 rounded justify-center content-center text-accent-2 hidden md:flex" href=""><img height={20} className="mr-3" src={Whatsapp} alt="Whatsapp Logo" />Let us talk about it.</a>
                    ...
                    <div className="w-full md:w-[30%] md:h-full flex flex-col justify-start">
                        ...
                        <div className="flex justify-between md:hidden">
                            <a className="w-fit py-[13px] hover:border-opacity-30 border p-3 border-solid border-accent-2 rounded flex justify-center content-center text-accent-2" href="/">
