                    ...
                    isLoggedIn ?
                        <div className="mt-5">
                            ...
                            <div className="mt-2 ml-4">
                                ...
                                <div className="flex flex-col ml-2">
                                    <label>Status Quo Background</label>
                                    <div className='mt-1 w-full'>
                            ...
                            <div className="mt-2 ml-4">
                                <h3 className="text-2xl font-bold">Our Sentiment</h3>
                            ...
                            <div className="mt-2 ml-4">
                                <h3 className="text-2xl font-bold">Archetypes Carousel</h3>
                                {   archetypesCarousel &&
                            ...
                            <div className="mt-2 ml-4">
                                <h3 className="text-2xl font-bold">After Table Image</h3>
